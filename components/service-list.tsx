  ...
  async function fetchServices() {
    try {
      ...
      if (tableError && tableError.message.includes("does not exist")) {
        setError(
          "A tabela 'services' não existe no banco de dados. Por favor, execute o script de configuração."
        )
        setServices([])
        setFilteredServices([])
        return
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Gerencie todos os serviços disponíveis no sistema</CardDescription>
      </CardHeader>
      <CardContent>
        {error && (
        ...
        <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
          <DialogContent className="sm:max-w-[425px]">
            ...
            <DialogFooter>
              ...
              <Button variant="destructive" onClick={deleteService} disabled={isLoading}>
                {isLoading ? (
                  <>
                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                    Excluindo...
