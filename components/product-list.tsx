...
import { Edit, MoreHorizontal, Search, Trash2, Package, ArrowUpDown, ChevronLeft, ChevronRight, Loader2 } from "lucide-react"
  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        ...
        if (tableCheckError) {
          throw new Error("A tabela de produtos não foi encontrada. Certifique-se de configurar o banco de dados corretamente.")
        }
        ...
        const errorMsg = error instanceof Error ? error.message : "Não foi possível carregar a lista de produtos."
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>
                      <Button variant="ghost" className="p-0" onClick={() => toggleSort("category")}>
                        <span>Categoria</span>
                        <ArrowUpDown className="ml-2 h-4 w-4" />
                      </Button>
                    </TableHead>
