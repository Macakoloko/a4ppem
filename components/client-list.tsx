...
import { Edit, MoreHorizontal, Search, Trash2, MessageCircle, Gift, Loader2, UserRound, ArrowUpDown, Calendar, ChevronLeft, ChevronRight } from "lucide-react"
  ...
  useEffect(() => {
    async function fetchClients() {
      try {
        ...
        const errorMessage = error instanceof Error ? error.message : "Não foi possível carregar a lista de clientes."
                ...
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="hidden md:table-cell">
                      <Button variant="ghost" className="p-0" onClick={() => toggleSort("birthday")}>
                    ...
                    <TableHead>
                      <Button variant="ghost" className="p-0" onClick={() => toggleSort("services")}>
                        <span>Serviços</span>
                        <ArrowUpDown className="ml-2 h-4 w-4" />
                      </Button>
                    </TableHead>
                  ...
                  {paginatedClients.length > 0 ? (
                    paginatedClients.map((client) => (
                      <TableRow key={client.id}>
                        ...
                        <TableCell className="hidden md:table-cell">{formatDate(client.birthday)}</TableCell>
                        ...
                        <TableCell className="text-right">
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              <DropdownMenuItem onClick={() => handleWhatsApp(client.whatsapp, client.name)}>
