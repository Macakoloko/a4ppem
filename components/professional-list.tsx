...
export function ProfessionalList() {
  ...
  async function fetchProfessionals() {
    try {
      ...
      if (tableError && tableError.message.includes("does not exist")) {
        setError(
          "A tabela 'professionals' não existe no banco de dados. Por favor, execute o script de configuração."
        )
        setProfessionals([])
  ...
  async function deleteProfessional() {
    ...
    try {
      ...
      const updatedProfessionals = professionals.filter(
        (professional) => professional.id !== deletingProfessionalId
      )
  ...
  async function handleUpdateProfessional(values: ProfessionalFormValues) {
    ...
    try {
      ...
      if (
        values.email !== editingProfessional.email ||
        values.phone !== editingProfessional.phone
      ) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Gerencie todos os profissionais cadastrados no sistema</CardDescription>
      </CardHeader>
      <CardContent>
        {error && (
        ...
        >
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              ...
              <DialogDescription>Atualize as informações do profissional abaixo.</DialogDescription>
            </DialogHeader>
            <Form {...form}>
        ...
        <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
          <DialogContent className="sm:max-w-[425px]">
            ...
            <DialogFooter>
              ...
              <Button variant="destructive" onClick={deleteProfessional} disabled={isLoading}>
                {isLoading ? (
                  <>
                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                    Excluindo...
